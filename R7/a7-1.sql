...
INSERT INTO events(name, date, place) VALUES('南アフリカワールドカップ','2010-01-01','南アフリカ');
...
INSERT INTO events(name, date, place) VALUES('カタールワールドカップ','2022-01-01','カタール');
...
SELECT * FROM events WHERE date < CURRENT_DATE AND name LIKE '%ワールドカップ%';